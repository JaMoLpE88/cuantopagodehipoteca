...
const SimulatorForm = () => {
  ...
  return (
    <>
      <section id="simulator" className="flex justify-center items-center flex-col">
        <label className="block tracking-wide text-xs font-bold mb-2" htmlFor="range_years">
          PLAZO DE HIPOTECA
        </label>
        <input
          id="range_years"
          ...
          max="40"
          min="3"
          className="w-full h-2 accent-indigo-600 bg-gray-50 border border-black overflow-hidden rounded-lg appearance-none cursor-pointer"
        ...
        <label className="block tracking-wide text-xs font-bold mt-4 mb-2" htmlFor="capital_input">
          CAPITAL PENDIENTE
        </label>
        <input
          type="number"
        ...
        <label className="block tracking-wide text-xs font-bold mt-4 mb-2" htmlFor="euract_input">
          EURIBOR ACTUAL
        </label>
        <input
          type="number"
        ...
        <label className="block tracking-wide text-xs font-bold mt-4 mb-2" htmlFor="diferencial_input">
          DIFERENCIAL
        </label>
        <input
          type="number"
        ...
        <label className="block tracking-wide text-xs font-bold mt-4 mb-2" htmlFor="eursim_input">
          EURIBOR SIMULADO
        </label>
        <input
          type="number"
        ...
        <table className="w-full text-sm text-gray-500">
          ...
          <tbody>
            <tr>
              ...
              <td className={`text-center py-4 px-6 ${result ? 'text-red-500 ' : 'text-green-500'}`}>
                {result ? <BsArrowUp className="inline" /> : <BsArrowDown className="inline" />}
                {cuotsim}€
              </td>
            </tr>
          </tbody>
